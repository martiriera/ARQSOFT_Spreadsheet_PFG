...
public abstract class SpreadsheetFactory {
     ...
     * 
     * @throws IllegalArgumentException if the String is not a correct cell coordinate
     */
     ...
     * 
     * @throws IllegalArgumentException if the string passed as argument does not 
     ...
     * @return the Range object created
     * @throws IllegalArgumentException if some of the strings passed as argument does not 
     ...
     * 
     * @throws IllegalArgumentException if the string passed does not represent any 
     * number
     */
